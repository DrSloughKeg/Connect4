...
function victory(player) {
  let displayR = document.getElementById("win");
  if (player == "player1") {
    displayR.innerHTML = "<h2>Black Wins!</h2><br>";
  } else if (player == "player2") {
    displayR.innerHTML = "<h2><span>Red</span> Wins!</h2><br>";
  }
}
function tieCondition() {
  ...
  if (red.length + black.length == 6 * 7) {
    let displayR = document.getElementById("win");
    displayR.innerHTML = "<h2>It's a Tie!</h2>";
    document.getElementById("container").style.display = "block";
  }
}
